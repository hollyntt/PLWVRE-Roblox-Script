...
for i,v in next, images do
    if not isfile(settings.folder_name..'/assets/'..i..'.ln') then
        writefile(settings.folder_name..'/assets/'..i..'.ln', crypt.encrypt('aes-ctr',game:HttpGet(v),'4XGudgFuutoHUM2C','zP5JJWPSIbf5Xuuy'))
    end
    images[i] = crypt.decrypt('aes-ctr',readfile(settings.folder_name..'/assets/'..i..'.ln'),'4XGudgFuutoHUM2C','zP5JJWPSIbf5Xuuy')
end
